...
export const translations = {
  de: {
    ...
    settings: {
      ...
      language: 'Sprache', changeEmail: 'Email ändern', changePassword: 'Passwort ändern', logout: 'Abmelden'
    },
    apps: {
  ...
  en: {
    ...
    settings: {
      ...
      language: 'Language', changeEmail: 'Change email', changePassword: 'Change password', logout: 'Log out'
    },
    apps: {
  ...
  tr: {
    ...
    settings: {
      ...
      language: 'Dil', changeEmail: 'E-postayı değiştir', changePassword: 'Şifreyi değiştir', logout: 'Çıkış yap'
    },
    apps: {
  ...
  pl: {
    ...
    settings: {
      ...
      language: 'Język', changeEmail: 'Zmień e-mail', changePassword: 'Zmień hasło', logout: 'Wyloguj się'
    },
    apps: {
  ...
  ru: {
    ...
    settings: {
      ...
      language: 'Язык', changeEmail: 'Изменить email', changePassword: 'Изменить пароль', logout: 'Выйти'
    },
    apps: {
  ...
  uk: {
    ...
    settings: {
      ...
      language: 'Мова', changeEmail: 'Змінити email', changePassword: 'Змінити пароль', logout: 'Вийти'
    },
    apps: {
  ...
  ro: {
    ...
    settings: {
      ...
      language: 'Limbă', changeEmail: 'Schimbă emailul', changePassword: 'Schimbă parola', logout: 'Deconectare'
    },
    apps: {
